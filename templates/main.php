            ...
            <article class="popular__post post <?=$popular["type"];?>">
                ...
                <div class="post__main">                    
                    <?php if($popular["type"] ==="post-quote") : ?>
                        ...
                        <blockquote>
                            <p>
                                <?=htmlspecialchars($popular["content"]);?>
                            </p>
                            ...
                            <a class="post-link__external" href="http://<?=htmlspecialchars($popular["content"]);?>" title="Перейти по ссылке">
                                <div class="post-link__info-wrapper">
                                    <div class="post-link__icon-wrapper">
                                        <img src="https://www.google.com/s2/favicons?domain=<?=htmlspecialchars($popular["content"]);?>" alt="Иконка">
                                    </div>
                                    <div class="post-link__info">
                                        <h3><?=htmlspecialchars($popular["title"]);?></h3>
                                    </div>
                                </div>
                                <span><?=htmlspecialchars($popular["content"]);?></span>
                            </a>
                        </div>
                    ...
                    <?php elseif($popular["type"] ==="post-video") : ?>
                        ...
                        <div class="post-video__block">
                            <div class="post-video__preview">
                                <?=embed_youtube_cover($popular["content"]); ?> 
                    ...
                    <div class="post__author">
                        <a class="post__author-link" href="#" title="Автор">
                            <div class="post__avatar-wrapper">
                                ...
                                <img class="post__author-avatar" src="img/<?=$popular["avatar"];?>" alt="Аватар пользователя">
                            </div>
